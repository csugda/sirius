...
using Assets.Scripts.Map.Decorators;
...
namespace Assets.Scripts.Map
{
    ...
    public class Map : MonoBehaviour
    {
        ...
        /// <summary>
        /// All decorators used in adding functionality to this map or in generating the map.
        /// Called in the order they are added (0->n)
        /// </summary>
        ...
        {
            if (MapParams.MaximumSectorSize.x < MapParams.MinimumSectorSize.x)
            {
                MapParams.MaximumSectorSize.x = MapParams.MinimumSectorSize.x;
            }
            if (MapParams.MaximumSectorSize.z < MapParams.MinimumSectorSize.z)
            {
                MapParams.MaximumSectorSize.z = MapParams.MinimumSectorSize.z;
            }
            ...
            {
                deco.SetSeed(rand.GetInt(Int32.MaxValue));
                deco.SetMap(this);
                deco.Generate();
            }
