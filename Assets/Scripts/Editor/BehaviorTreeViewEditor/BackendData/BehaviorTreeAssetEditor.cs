...
namespace BehaviorTreeViewEditor.BackEndData
{
	...
	public class BehaviorTreeAssetEditor : UnityEditor.Editor
    {
        ...
        void Save()
        {
            //save state... selected item, closed/opened views, etc... DOES NOT SAVE ACTUAL TREE!
            ...
            TreeElementUtility.TreeToList(_TreeView.treeModel.root, treeList);
            ...
            Debug.Log(treeList.Count + " "  + tree + JsonUtility.ToJson(treeList));
        }

        BehaviorTreeView Load()
        {
            ...
            return new BehaviorTreeView(treeViewState, treeModel);
        }
		...
		void ToolBar ()
		{
            ...
            if (GUILayout.Button("Remove Behavior", style))
            {
